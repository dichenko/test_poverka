...
/report_all_org [DD/MM/YYYY] — отправить готовые отчеты всем организациям за указанную дату (без генерации)
Пример: /report_all_org 01/04/2026

/report_id_org [id] [DD/MM/YYYY] — отправить готовый отчет конкретной организации по id за указанную дату (без генерации)
